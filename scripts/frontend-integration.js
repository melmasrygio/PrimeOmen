 ...
 * This file demonstrates how to integrate Primeomen with a web frontend
 */

// For React/Vue/Angular applications
export class PrimeomenClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PrimeomenClient(provider, contractAddress);
